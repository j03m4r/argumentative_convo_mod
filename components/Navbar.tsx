        ...
        <nav className="sticky top-0 left-0 w-20 h-screen border-r border-black flex flex-col items-center pt-4 bg-cream">
            ...
            {user&&(
                <div className="flex flex-col h-full mt-4 border-t border-black w-full items-center">
                    ...
                    <div className="mt-auto hover:text-blood-orange w-full flex p-4 justify-center items-center border-t border-black cursor-pointer transition-colors duration-200 ease-in-out">
...
function NavItem({ 
    ...
    return (
        <div
            className={`w-full flex p-4 justify-center items-center border-b border-black cursor-pointer transition-colors duration-200 ease-in-out
                ${active ? 'text-blood-orange' : 'text-black hover:text-blood-orange'}`}
        >
            {children}
        </div>
    );
