...
import { updateInitialResponse, getUserData, updateFinishedModerationStatus, updateRevisedResponse, updateUpVoteStatus, addConversationMessages } from "@/lib/firebase/firestore";
        ...
        const loadSavedConversation = async () => {
            ...
            try {
                ...
                if (userData) {
                    ...
                    setRevisedReply(userData.revisedResponse || "");
                    if (userData.revisedResponse) {
                        setHasFilled(true);
                    }
    ...
    const handleReply = (reply: string) => {
        if (userId) {
            if (finishedModeration) {
                ...
                // TODO :: post it to comment section
                // TODO :: move to next phase of study
            } else {
    ...
    return (
        <div className="flex flex-col h-screen w-full">
            ...
            <div className="flex justify-between items-center w-full py-2 shrink-0">
                ...
                <div className="px-4 py-2 flex justify-center items-center cursor-not-allowed">
            ...
            <div className='gap-y-4 w-full flex flex-col justify-center items-center border-b border-black shrink-0'>
                ...
                <div className='w-full flex justify-center items-center border-t border-black'>
                    ...
                    <div className="flex items-center justify-center gap-x-1 px-4 py-2 cursor-not-allowed transition-colors duration-200 ease-in-out">
                ...
                {isModeration ? (
                    ...
                    <>
                        <div className='relative flex w-full items-center'>
                            <button onClick={handleFillClick} className={`${(!finishedModeration||hasFilled)&&'hidden'} gap-x-2 absolute right-2 bottom-2 rounded-md bg-blood-orange text-cream px-2 py-1 hover:bg-blood-orange/80 cursor-pointer transition-colors duration-200 ease-in-out flex justify-center items-center`}>
                        ...
                        <div className="flex-1 flex justify-center items-center text-sm font-light">
                            {isLoadingModeration ? (
                                <OrbitProgress color="#ff3f34" size="medium" text="" textColor="" />
                            ) : (
